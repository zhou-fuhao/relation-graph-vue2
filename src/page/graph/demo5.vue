<template>
  <div>
    <el-button type="success" class="c-show-code-button">
      <el-link href="https://github.com/zhou-fuhao/relation-graph-vue2/tree/master/src/page/graph/demo5.vue"
    ...
    <div ref="myPage" style="height:calc(100vh - 80px);" @click="isShowNodeMenuPanel = false">
...
import MyLine from './Demo5SlotComp';
export default {
  name: 'RelationGraphDemo5',
  components: { MyLine },
  data() {
    return {
